  ...
  return (
    ...
    >  
      ...
      <h1>Contact us</h1>|
       ...
       <img onClick={()=>navigate("/cart")} width={50} style={{marginTop:"10px",borderRadius:"20px",padding:"10px"}} src="https://media.istockphoto.com/vectors/shopping-cart-icon-isolated-on-white-background-vector-id1206806317?k=20&m=1206806317&s=170667a&w=0&h=kEh5VLsTHukWc7xf2BvUs8ssqS_d7vkK0-xU3MDpO7s=" />
